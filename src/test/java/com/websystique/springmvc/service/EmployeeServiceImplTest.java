...
//Презентация: Придумать проблему которую помогают решить моки, показать как она решается без моков, потом
// рассказываешь как работают моки, потом рассказать как они тут работают помогают, а потом ссылка на пример с кодом
//в гитхаб.